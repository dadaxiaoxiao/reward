...
var thirdPartyProvider = wire.NewSet(ioc.InitEtcdClient, ioc.InitOTEL, ioc.InitRedis, ioc.InitDB, ioc.InitLogger, ioc.InitPaymentGRPCClient, ioc.InitAccountGRPCClient, ioc.InitKafka, ioc.NewConsumers)
